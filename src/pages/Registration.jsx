...
import Registration_video from '/videos/video2.mp4';
      ...
      <div className="RegistrationImage">
        <form method='POST' onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input
              type="text"
              className='bg-transparent text-white placeholder-white focus:outline-none focus:ring-2 focus:ring-black'
              name="name"
              id="name"
          ...
          <div className="mb-4">
            ...
            <input
              ...
              name="email"
              id="email"
              className='bg-transparent text-red-800 placeholder-white focus:outline-none focus:ring-2 focus:ring-red-100'
          ...
          <div className="mb-4">
            ...
            <input
              ...
              id="confirmPassword"
              className='bg-transparent text-white placeholder-white focus:outline-none focus:ring-2 focus:ring-red-100'
          ...
          <div className="flex justify-center mb-6">
            ...
            <button
              ...
              className={`font-semibold py-2 px-6 rounded-lg shadow-md transition-transform duration-200 ease-in-out ${isSubmitting
